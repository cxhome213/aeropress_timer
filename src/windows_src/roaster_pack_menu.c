...
static void draw_row_callback(GContext *ctx, Layer *cell_layer, MenuIndex *cell_index, void *context) {
  switch(cell_index->row) {
    case 0:
      menu_cell_basic_draw(ctx, cell_layer, "Blue Bottle", NULL, s_icon_bitmap_menu_1);
      break;
    case 1:
      menu_cell_basic_draw(ctx, cell_layer, "Tonx", NULL, s_icon_bitmap_menu_2);
      break;
		case 2:
      menu_cell_basic_draw(ctx, cell_layer, "Verve", NULL, s_icon_bitmap_menu_3);
      break;
		case 3:
      menu_cell_basic_draw(ctx, cell_layer, "Seeds", NULL, s_icon_bitmap_menu_4);
      break;
		case 4:
      menu_cell_basic_draw(ctx, cell_layer, "Clive", NULL, s_icon_bitmap_menu_5);
      break;
		case 5:
      menu_cell_basic_draw(ctx, cell_layer, "Doubleshot", NULL, s_icon_bitmap_menu_6);
      break;
		case 6:
      menu_cell_basic_draw(ctx, cell_layer, "Tim Wendelboe", NULL, s_icon_bitmap_menu_7);
      break;
    default:
      break;
  }
...
static void draw_header_callback(GContext *ctx, const Layer *cell_layer, uint16_t section_index, void *context) {
  ...
  text_layer_set_text_alignment(s_text_layer, GTextAlignmentCenter);
	text_layer_set_text(s_text_layer, "ROASTER PACK");
}
